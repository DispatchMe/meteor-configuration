 ...
 */
Configuration.setForEntity = Meteor.wrapAsync(function(type, id, props, overwrite, callback) {
...
Configuration._insertDefault = function(doc, callback) {
  return Configuration.Collection.insert({
    _id: '_default',
    entityType: '_default',
    entityId: '_default',
    config: doc
...
Configuration.setDefault = function(doc, callback) {
  ...
  if (exists) {
    ...
    Configuration._insertDefault(doc, callback);
  }
};
...
Configuration.setDefaultForPrefix = function(prefix, data, callback) {
  if (!Configuration.hasDefault()) {
    var doc = {};
    doc[prefix] = data;
    return Configuration._insertDefault(doc, callback);
  }
