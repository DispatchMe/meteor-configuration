...
Configuration.setSchema = function(simpleSchema) {
  // Everything is optional since it's inherited, so just add `optional:true` to 
  // every property
  ...
  Configuration._schema = simpleSchema = new SimpleSchema(schema);
 ...
 * @returns {Object}          A configuration object. Non-object properties within it will set 
